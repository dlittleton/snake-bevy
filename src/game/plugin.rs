...
use super::cell::{CellBundle, CellContents, CoordinateTranslator};
use super::constants::*;
use super::grid::Grid;
...
/**
 * Plugin implementing the actual snake gameplay.
 */
...
impl Plugin for GamePlugin {
    fn build(&self, app: &mut App) {
        ...
        app.add_systems(PreUpdate, read_input.run_if(in_state(GameState::Playing)));
        app.add_systems(
            FixedUpdate,
        ...
        app.insert_resource(Time::<Fixed>::from_seconds(0.04));
    }
}

/**
 * Catch all object for gameplay state.
 *
 * Maybe this should be broken into more components to better embrace the ECS?
 */
#[derive(Resource)]
struct Game {
